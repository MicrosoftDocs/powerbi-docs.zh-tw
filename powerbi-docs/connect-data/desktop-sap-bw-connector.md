...
* 適用于 Windows 32 位 (x86) 或更新版本的 SAP Connector for Microsoft .NET 3.0.22.0 ( .NET Framework 4.0) 
* 適用于 Windows 64 位 (x64) 或更新版本的 SAP Connector for Microsoft .NET 3.0.22.0 ( .NET Framework 4.0) 

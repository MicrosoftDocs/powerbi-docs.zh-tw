---
title: 如何將 Power BI 工作區集合內容移轉至 Power BI 內嵌式分析 Power BI Embedded 解決方案中，以取得更佳的內嵌 BI 見解
description: 了解如何從 Power BI 工作區集合遷移至 Power BI Embedded，並利用內嵌在應用程式中的進階功能。 使用 Power BI 內嵌式分析，以便取得更佳的內嵌 BI 見解。
author: KesemSharabi
ms.author: kesharab
ms.service: powerbi

...
如果您想要在報表中新增指向另一個 Power BI 項目的連結，只需從瀏覽器網址列複製該項目的 URL。 閱讀更多[如何將超連結新增至報表中的文字方塊](../../create-reports/service-add-hyperlink-to-text-box.md)相關資訊。

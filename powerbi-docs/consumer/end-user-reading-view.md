...
在此快速入門中，您會了解如何與 Power BI 互動，探索資料驅動商務見解。 此文章不適合用於深入了解，而是快速探索可供 Power BI「商務使用者」使用的許多動作。
...
![螢幕擷取畫面說明 Power BI 如何從各種來源取得內容並輸出報表。](./media/end-user-reading-view/power-bi-concept.png)

在瀏覽器或行動裝置上開啟 Power BI 服務。 您和同事可以從相同的受信任應用程式、儀表板與報表執行作業；其會自動更新及重新整理，因此您一律會使用最新的內容。   

## <a name="reading-view"></a>閱讀檢視
Power BI 服務中有兩種模式可與報表互動：編輯檢視和閱讀檢視。  如果您是「商務使用者」，則您較可能會使用閱讀檢視來取用其他人所建立的報表。 報表「設計師」會使用編輯檢視來建立報表並與您共用。 閱讀檢視是探索同事所建立的報表並與其互動的方式。 



即使在閱讀檢視中，內容也不是靜態的。 您可以深入探索以尋找趨勢、見解與其他商業智慧。 對內容進行分析，甚至用您自己的話來詢問問題。 或者，放心讓資料為您探索有趣的見解、在資料變更時傳送警示給您，並依照您設定的排程以電子郵件傳送報表給您。 這包括您來自任何裝置、不分時間的所有資料，無論它是位於雲端或內部部署中。 
...
「應用程式」是將相關儀表板和報表全都結合到同一處的 Power BI 內容類型。 應用程式可以有一或多個儀表板和一或多個報表，所有儀表板和報表都會組合在一起。 應用程式是由 Power BI「設計師」所建立，這些設計師會散發應用程式，並與像您一樣的「商務使用者」共用。 

檢視應用程式的其中一種方法是從導覽窗格選取 [應用程式]，然後選取要開啟的應用程式。

![[應用程式] 畫面的螢幕擷取畫面，其中顯示八個不同的應用程式。](./media/end-user-reading-view/power-bi-app.png)

若要深入了解檢視應用程式，請參閱 [Power BI 應用程式](end-user-apps.md)

### <a name="reports"></a>報表

Power BI 報表是一種資料集的多角度檢視，可透過視覺效果表示該資料集不同的尋找結果和見解。 報表可以具備單一視覺效果，或是充滿視覺效果的頁面。 報表是由 Power BI「設計師」所建立，這些設計師會散發報表，並與像您一樣的「商務使用者」共用。

![此圖顯示位於行動電話和電腦瀏覽器上的相同報表。](./media/end-user-reading-view/power-bi-report-phone.png)
...
![此圖顯示在行動電話和電腦瀏覽器畫面上顯示相同的儀表板。](./media/end-user-reading-view/power-bi-dashboard-phone.png)

若要了解如何檢視儀表板，請參閱 [Power BI 儀表板](end-user-dashboards.md)
 
## <a name="interact-in-the-power-bi-service"></a>在 Power BI 服務中互動

### <a name="collaborate-with-colleagues"></a>與同事共同作業
略過電子郵件。 直接在儀表板上新增個人註解，或是和同事開始進行與該儀表板相關的交談。 註解功能只是您可與其他人共同作業的其中一種方法。 

![註解影片](./media/end-user-reading-view/comment.gif)

深入了解[註解](end-user-comment.md)

### <a name="sit-back-and-let-power-bi-work-for-you"></a>放鬆並讓 Power BI 為您工作
...
![選取訂閱圖示](./media/end-user-reading-view/power-bi-subscribe-and-email.png)
...
![問與答](./media/end-user-reading-view/power-bi-q-and-a-funnel.png)
...
當您將內容設為「我的最愛」時，便可從[首頁](end-user-home.md)和導覽窗格加以存取。 Power BI 服務中幾乎每一個區域都能看到導覽窗格。 我的最愛通常是儀表板、報表頁面，以及您最常前往的應用程式。

若要將內容儲存為我的最愛，請從 Power BI 服務的右上角，選取星號圖示。 
   
![螢幕擷取畫面顯示儀表板右上角，其中的星號圖示以紅色框線框起來。](./media/end-user-reading-view/power-bi-favorite-icon.png)

若要查看我的最愛，請從導覽窗格中選取 [我的最愛]。

![[首頁] 的螢幕擷取畫面，其中已選取 [我的最愛] 並以紅色框線框起來。](./media/end-user-reading-view/power-bi-list-favorite.png)

查看功能表列中可供使用的其他動作。  我們並不會在此文章中涵蓋所有動作，但會在其他文章中加以討論。  使用 Power BI 目錄或 [搜尋] 欄位來深入了解。 
...
若要調整，請從右上角的功能表列中選取 [檢視] 圖示，然後選擇其中一個顯示選項。 

![報告檢視功能表](media/end-user-reading-view/power-bi-view-icon.png)
...
![螢幕擷取畫面顯示焦點模式視覺效果已填滿整個畫布。](media/end-user-reading-view/power-bi-fullscreen-after.png)

若要顯示相同的視覺效果，而不受功能表列、篩選窗格和其他 Chrome 的干擾，請從 [檢視] 下拉式功能表中選取 [全螢幕]。   

![螢幕擷取畫面顯示 [檢視] 下拉式功能表。](media/end-user-reading-view/power-bi-focus.png)

![螢幕擷取畫面以全螢幕模式顯示相同視覺效果。](media/end-user-reading-view/power-bi-full.png)
...
Power BI 視覺效果是使用基礎資料集中的資料所建構。 如果您對背景資料有興趣，Power BI 可讓您「顯示」用來建立視覺效果的資料。 當您選取 [顯示為資料表] 時，Power BI 會在視覺效果下方 (或旁邊) 顯示資料。

在視覺效果啟用的情況下，選取 [更多選項] (...) 並選擇 [顯示為資料表]。
   
   ![螢幕擷取畫面顯示位於上方的區域圖，並在下方顯示含有資料的資料表。](./media/end-user-show-data/power-bi-show-data-table.png)


### <a name="export-data-to-excel"></a>將資料匯出至 Excel
...
![匯出至 Excel 的資料](./media/end-user-reading-view/power-bi-export-powerpoint.png)

<!-- Exporting isn't limited to individual visuals; you can export entire reports to PowerPoint or PDF to share with your colleagues.

![data exported to PowerPoint](./media/end-user-reading-view/power-bi-export-powerpoint.png) -->

這是針對「商務使用者」可搭配 Power BI 服務執行之一部分工作的快速概觀。  

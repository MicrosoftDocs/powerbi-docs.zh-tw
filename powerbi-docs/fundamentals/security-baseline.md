...
- [Azure 安全性效能評定 - 資產管理](https://docs.microsoft.com/azure/security/benchmarks/security-controls-v2-asset-management)
...
- [Azure 安全性效能評定 - 狀態和弱點管理](https://docs.microsoft.com/azure/security/benchmarks/security-controls-v2-posture-vulnerability-management)
...
- [Azure 安全性效能評定 - 身分識別管理](https://docs.microsoft.com/azure/security/benchmarks/security-controls-v2-identity-management)
